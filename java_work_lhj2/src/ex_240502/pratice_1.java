...
//	                pickRandomContactWithCountdown(dic, scanner);
...
//	    }
//
//	    private static void pickRandomContactWithCountdown(HashMap<String, Person> dic, Scanner scanner) {
//	        System.out.print("카운트다운 시간(초)을 입력하세요: ");
//	        int countdownSeconds = scanner.nextInt();
//	        if (dic.isEmpty()) {
//	            System.out.println("연락처가 비어있습니다.");
//	        } else {
//	            System.out.println(countdownSeconds + "초 후에 랜덤한 연락처를 선택합니다.");
//	            try {
...
//	                System.out.println("카운트다운 중단되었습니다.");
//	            }
//	        }
//	    }
//
